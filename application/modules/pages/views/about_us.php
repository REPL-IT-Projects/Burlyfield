			<section class="breadcrumb-area" style="background-image:url(<?php echo base_url();?>public/front_assets/images/background/about-us.jpg);">
			...
			<section class="four-column delivery-process">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<div>
								<figure class="img-holder">
								<img src="<?php echo base_url().'public/front_assets/images/award.jpg'; ?>" alt="">
							</figure>
							</div>
							<!-- <div class="partners wow fadeInUp">
	        	
	        		<div id="partner_logo" class="owl-carousel owl-theme">
						<div class="item"><img src="<?php echo base_url(); ?>public/front_assets/images/about/gold-trophy.jpg" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url(); ?>public/front_assets/images/about/gold-trophy.jpg" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url(); ?>public/front_assets/images/about/gold-trophy.jpg" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url(); ?>public/front_assets/images/about/gold-trophy.jpg" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url(); ?>public/front_assets/images/about/gold-trophy.jpg" alt="logo"></div>
