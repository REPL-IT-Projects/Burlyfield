<?php  foreach ($banner_cat as $value) {
// echo $value['var_icon'];die();
$image = base_url().'uploads/category/'.$value['var_icon']; }?>
<section class="breadcrumb-area" style="background-image:url(<?php echo $image;?>);">
			    <!-- <div class="container">
			        <div class="row">
			            <div class="col-md-12">
	        			...
	        			<div class="col-lg-9 col-md-8 col-sm-12 col-sx-12">
		        			...
		        			<div class="row">
				            	...
				            	foreach ($products as $row1){
				            	    if($cat['int_glcode'] == $row1['fk_category']){
				            	?>
					            <!--Default Item-->
					                  ...
					                  <!--  <div class="overlay-box">
					                        	<div class="inner">
						                        	...
						                        	<div class="bottom-content">
						                        		...
						                        		<p><?php if($row1['var_stock'] == 0){ echo "Out of Stock"; } else if($row1['var_stock'] < 5) { echo $row1['var_stock']." Items left";}
				                        				?></p>
