...
class Deliveryboy_model extends CI_Model {
    ...
    {          
        $this->db->select('mb.int_glcode,mb.var_name,mb.var_email,mb.var_mobile_no,mb.var_profile,mb.chr_status,mb.current_status,mb.chr_publish,mb.chr_delete,mb.dt_createddate');
        $this->db->from('mst_delivery_boy mb');
        //$this->db->where('mb.fk_vendor',$id);  
