...
<head>
	...
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>public/assets/admin_images/favicon/favicon.ico">
	<title>Vruits</title>
	<style type="text/css">
	body {
		color: #3e5569;
...
<body>
	<div class="main-wrapper">
		...
		<a href="<?php echo base_url(); ?>vendor" class="btn btn-danger btn-rounded waves-effect waves-light mb-5">Back to home</a>
	</div>
</div>
