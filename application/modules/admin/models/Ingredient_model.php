...
class Ingredient_model extends CI_Model {
    ...
    public function addRecord()
    {
        ...
        {
	        if (!is_dir('uploads/ingredient')) {
			 	mkdir('uploads/ingredient', 0777, TRUE);
			}
        ...
        $id = $this->common_model->insertRow($data, "mst_ingredient");
    ...
    public function updateRecord($userId)
    {
        ...
        $this->common_model->updateRow('mst_ingredient', $data, array("int_glcode" => $userId));
    ...
    public function delete_multiple()
    {
        ...
        foreach ($id as $key => $value) {
            ...
            if($this->db->update("mst_ingredient",$data))
            {
                $i++;
