            ...
            <div class="card">
                <form method="POST" action="<?php echo base_url().'admin/category/update_category/'.$data['int_glcode']; ?>" class="form-horizontal" enctype='multipart/form-data'>
                    <div class="card-body">
                        ...
                        <input type="hidden" value="0" id="fk_parent" name="fk_parent">
                        ...
                        <div class="form-group row">
                            <label for="var_image" class="col-sm-3 text-right control-label col-form-label">Category Banner Image<br>(Don't use symbols in your file name)</label>
                                  <?php
                            if ($data['var_icon'] != '') {
