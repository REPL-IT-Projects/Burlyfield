            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Product Feedback</h4>
            ...
            <div class="card-body table-responsive">
                <table id="users_list" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tr style="background-color: rgba(0, 0, 3, 0.1);">
                    ...
                    <th><a href="javascript:void(0);" field="username" class="_sort">Product name</a></th>
                    ...
                    <th><a href="javascript:void(0);" field="dt_createddate" class="_sort">Rate</a></th>
                    <th>Publish</th>
                </tr>
                </thead>
                <input type="hidden" name="module" id="module" value="feedback">
                <tbody>
                    <?php 
                    if (count($data) > 0) {
                        foreach ($data as $row) {
                        ...
                        <tr id="<?php echo $row["int_glcode"]; ?>">
                            ...
                            <td><?php echo $row['var_rate']; ?> <i class="fa fa-star"></i></td>
                            <td class="center">
                                <a href="javascript:void(0);">
                                  <img id="tick-<?php echo $row['int_glcode']; ?>" height="16" width="16" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" src="<?php echo base_url() . 'public/assets/images/site_imges/' . $tickimg; ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('feedback', 'mst_review', 'chr_publish', '<?php echo $update_val; ?>', '<?php echo $row['int_glcode']; ?>');">
                                </a>
                            </td>
                        </tr>
                        <?php } 
...
<script type="text/javascript">
  ...
  $('#frm_MessageSubmit').on('submit', (function (e) {
                        ...
                        $.ajax({
                            url: siteurl + "admin/feedback/submit_report",
                            type: 'POST',
                            data: formData,
                            async: false,
...
//                                $("#patient_info_Modal").hide();
 ...
 $("#btn_search").click(function(){
  ...
  $.ajax({
    ...
    url: siteurl+'admin/feedback/loadStaff/'+pagenumber,
    type: 'get',
  ...
  var entries = $('select[name=dp_entries]').val();
    ...
    function loadPagination(pagno,field = 'int_glcode',sort = 'desc',entries = '10'){
      ...
      $.ajax({
       ...
       url: siteurl+'admin/feedback/loadStaff/'+pagno,
    ...
    function createTable(result,sno,total_rows,total_staff){
      ...
      for(index in result){
        ...
        var var_rate = result[index].var_rate;
        ...
        tr += "<td>"+ var_rate +"  <i class='fa fa-star'></i></td>";
