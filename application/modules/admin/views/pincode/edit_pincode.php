<div id="main-wrapper">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/pincode">View Pincode</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form method="POST" action="<?php echo base_url().'admin/pincode/update_pincode/'.$data['int_glcode']; ?>" class="form-horizontal" enctype='multipart/form-data'>
                    <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" id="var_name" name="var_pincode" placeholder="Enter Pincode Here" value="<?=$data['var_pincode'];?>" required="">
              </div>
            </div>
            <div class="form-group row">
              <!--<div class="col-sm-7">-->
                    <label class="control-label text-right col-md-3">Status<span class="valid-text">*</span></label>
                        <div class="col-md-7">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline1" name="flag" class="custom-control-input" value="E" <?php if($data['flag']=='E'){echo "checked";}?>>
                                <label class="custom-control-label" for="customRadioInline1">Enabled</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadioInline2" name="flag" class="custom-control-input" value="D" <?php if($data['flag']=='D'){echo "checked";}?>>
            ...
            <!-- <div class="form-group row">
              ...
              <div class="col-sm-7">
                <select class="form-control" id ="var_city" name="int_day" required="">
                    ...
                    <option value="1" <?php if($data['int_day']=='1'){echo "selected";}?>>Tuesday Or Friday</option>
                    <option value="2" <?php if($data['int_day']=='2'){echo "selected";}?>>Wednesday Or Saturday</option>
                    <option value="3" <?php if($data['int_day']=='3'){echo "selected";}?>>Thursday Or Sunday</option>
                </select>
              </div>
            </div> -->
        </div>
