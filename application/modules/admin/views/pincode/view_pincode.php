                ...
                <div class="row">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Pincode Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                           <a id="add_cate" href="<?php echo base_url(); ?>admin/pincode/add_pincode" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add Pincode</a>
                       </div>
                   </div>
               </div>
           </div>
            ...
            <div class="card-body table-responsive">
                <table id="user_list" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tr style="background-color: rgba(0, 0, 3, 0.1);">
                    ...
                    <!--</span></th>-->
                    <th><a href="javascript:void(0);" field="var_pincode" class="_sort">Pincode</a></th>
                    <th>Status</th>
                    <!-- <th>Day</th> -->
                ...
                <input type="hidden" name="module" id="module" value="mst_pincode">
                <tbody>
                    <?php 
                    if (count($data) > 0) {
                        foreach ($data as $row) { 
                        ...
                        <tr id="<?php echo $row["int_glcode"]; ?>">
                            ...
                            <td><a href="<?php echo base_url() . 'admin/pincode/editpincode/'. base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['var_pincode']; ?></a>
                            </td>
                            ...
                            <tr><th colspan="4"><td>No data are available.</td></th></tr>
                        <?php } ?>
                    </tbody>
                </table>
...
<script type="text/javascript" src="<?php echo base_url(); ?>public/dist/js/pincode.js"></script>