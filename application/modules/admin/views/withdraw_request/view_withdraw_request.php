            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Vendor Withdraw Request</h4>
...
function approved_request(id){
            ...
            swal({
              ...
              if (result.value) {
                $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/withdraw_request/approved_request",
                data: 'id='+id,

                    success: function(data){
                        window.location.href = '<?php echo base_url();?>admin/withdraw_request';
  ...
  $('#btn_exportExcel').click(function(){
    ...
    var url = "<?php echo base_url();?>admin/withdraw_request/admin_withdraw_toExcel";
    window.location = url;
  });
</script>