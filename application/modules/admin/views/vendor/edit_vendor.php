            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="form-group row">
              <label for="var_latitude" class="col-sm-3 text-right control-label col-form-label">City</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" id="var_city" name="var_city" value="<?php echo $data['var_city']; ?>" placeholder="City">
              </div>
            </div>
            <div class="form-group row">
              <label for="var_longitude" class="col-sm-3 text-right control-label col-form-label">State </label>
              <div class="col-sm-7">
                <input type="text" class="form-control" id="var_state" name="var_state" value="<?php echo $data['var_state']; ?>" placeholder="State">
              </div>
            </div>
                    <div class="form-group row">
...
<script type="text/javascript">
var geo_key = '<?php echo GEOCODE_KEY; ?>';
$(document).ready(function(){
  ...
  function showPosition(){
        navigator.geolocation.getCurrentPosition(function(position){
          ...
          $.get( "https://maps.googleapis.com/maps/api/geocode/json?latlng="+ lat + "," + long +"&location_type=ROOFTOP&key="+geo_key+"", function(data) {
             console.log(data);
