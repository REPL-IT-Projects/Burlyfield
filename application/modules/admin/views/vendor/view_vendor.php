                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                           ...
                           <a id="add_cate" href="<?php echo base_url(); ?>admin/vendor/createXLSVendors" class="btn btn-primary btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-export"></i>Export Excel</a>
                           <a id="add_cate" href="<?php echo base_url(); ?>admin/vendor/pdf_viewer_vendor" class="btn btn-primary btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-export"></i>Export PDF</a>
                       </div>
                   </div>
               </div>
           </div>
                ...
                <tbody>
                    ...
                    if (count($data) > 0) {
                        ...
                        <td>
                            ...
                            <td><a class="btn btn-primary btn_view" href="<?php echo base_url() . 'admin/vendor/viewOrders/'. base64_encode($row['int_glcode']); ?>">View Orders</a></td>
                        </tr>
                            <?php } 
                        } else { ?>
