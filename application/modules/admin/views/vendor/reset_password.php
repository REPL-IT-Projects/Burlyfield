...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo base_url(); ?>public/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div>
                    <div class="logo">
                        <span class="db"><img src="<?php echo base_url(); ?>public/assets/images/site_imges/Logo.png" alt="logo" /></span>
    ...
    <script type="text/javascript">
        ...
        function reset_password() {
            $.ajax({
                type: "POST",
                url: sitepath + "admin/vendor/reset_password_action",
                data: $("#formReset_password").serialize(),
                success: function (response) {
                    if (response == 1) {
                       $("#formReset_password")[0].reset();
                       var msg =  "Reset Password Successfully.";
