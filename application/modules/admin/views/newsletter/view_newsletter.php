        ...
        <!-- ============================================================== -->
           ...
           <div class="container-fluid">
            ...
            <div class="card-body table-responsive">
                ...
                <input type="hidden" name="module" id="module" value="newsletter">
                <tbody>
                    <?php 
                    if (count($data) > 0) {
                        foreach ($data as $row) {
...
//                                $("#patient_info_Modal").hide();
 ...
 $("#btn_search").click(function(){
  ...
  $.ajax({
    ...
    url: siteurl+'admin/newsletter/loadStaff/'+pagenumber,
    type: 'get',
  ...
  var entries = $('select[name=dp_entries]').val();
    ...
    function loadPagination(pagno,field = 'int_glcode',sort = 'desc',entries = '10'){
      ...
      $.ajax({
       ...
       url: siteurl+'admin/newsletter/loadStaff/'+pagno,
    ...
    function createTable(result,sno,total_rows,total_staff){
       ...
       if(result == null || result == ''){
        ...
        var tr = '<tr><td colspan="3">No results</td></tr>';        
