                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                           <a id="add_cate" href="<?php echo base_url(); ?>admin/news/add_news" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add New News</a>
                       </div>
                   </div>
               </div>
           </div>
                    ...
                    if (count($data) > 0) {
                        foreach ($data as $row) {
                            ...
                            if(substr($row['var_image'], 0, 4 ) === "http")
                            {
                                ...
                                $Image = base_url().'uploads/news/'.$row['var_image'];
                            } else {
                        ...
                        <td><a href="<?php echo base_url() . 'admin/news/edit_news/'. base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['var_name']; ?></a>
                        </td>
                        ...
                        <td><?php echo $row['txt_description']; ?></td>
                            <td class="center">
                                <a href="javascript:void(0);">
                                  <img id="tick-<?php echo $row['int_glcode']; ?>" height="16" width="16" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" src="<?php echo base_url() . 'public/assets/images/site_imges/' . $tickimg; ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('news', 'mst_news', 'chr_publish', '<?php echo $update_val; ?>', '<?php echo $row['int_glcode']; ?>');">
                                </a>
                            </td>
                        </tr>
                            <?php } 
