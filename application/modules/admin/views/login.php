	...
	<div class="main-wrapper">
		...
		<div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo base_url(); ?>public/assets/images/big/auth-bg.jpg) no-repeat center center;">
			<div class="auth-box">
				<div id="loginform">
					<div class="logo">
						<span class="db"><img src="<?php echo base_url(); ?>public/front_assets/images/logo.png" alt="vruits" /></span>
	...
	<div class="modal-content">
       <!--  <div class="modal-header">
        ...
        <div class="modal-body">
        	...
        	<form class="sign-in-form" id="frm_forgotpass" action="<?= base_url(); ?>admin/forgotPassword">     <!-- forget_password -->               
