						...
						<div class="card-body border-top">
							<div class="row mb-0">
								...
								<div class="col-lg-3 col-md-6">
									<div class="d-flex align-items-center">
										<div class="mr-2"><span class="text-orange display-5"><i class="fas fa-users"></i></span></div>
								...
								<div class="col-lg-3 col-md-6">
									<div class="d-flex align-items-center">
										<div class="mr-2"><span class="text-cyan display-5"><i class=" fas fa-user-plus"></i></span></div>
								...
								<div class="col-lg-3 col-md-6">
									<div class="d-flex align-items-center">
										<div class="mr-2"><span class="text-info display-5"><i class="fas fa-cubes"></i></span></div>
										<div><span>Total Product</span>

											<h3 class="font-medium mb-0"><?php echo $products; ?></h3></div>
										</div>
									</div>
									<!-- col -->
									<!-- col -->
									<div class="col-lg-3 col-md-6">
										<div class="d-flex align-items-center">
											<div class="mr-2"><span class="text-primary display-5"><i class="fas fa-clipboard-list"></i></span></div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<!-- column -->
									<div class="col-lg-4">
										<h1 class="mb-0 mt-4"><i class="fas fa-rupee-sign"></i> <?php echo $current_tot; ?></h1>
...
<script type="text/javascript">
    ...
    var o = c3.generate({
        bindto: "#donut-chart",
        color: { pattern: ["#ffaf0e", "#f62d51", "#2ea08c"] },
        data: {
            columns: [
                ["option1", 30],
                ["option2", 120]
