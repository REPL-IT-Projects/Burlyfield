       ...
       <?php echo validation_errors(); ?>
                ...
                <div class="row">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">All Ingredients for Health</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                           <a id="add_cate" href="<?php echo base_url(); ?>admin/ingredient/add_ingredient" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add New Ingredients </a>
                       </div>
                   </div>
               </div>
           </div>
           <div class="container-fluid">
            ...
            <div class="card-body table-responsive">
                ...
                <input type="hidden" name="module" id="module" value="ingredient">
                <tbody>
                    <?php 
                    if (count($data) > 0) {
                        foreach ($data as $row) {
                            ...
                            if(substr($row['var_image'], 0, 4 ) === "http")
                            {
                                ...
                                $Image = base_url().'uploads/ingredient/'.$row['var_image'];
                            } else {
                        ...
                        <td><a href="<?php echo base_url() . 'admin/ingredient/edit_ingredient/'. base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['var_name']; ?></a>
                        </td>
