...
<div id="main-wrapper">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form method="POST" action="<?php echo base_url().'admin/blog/update_blog/'.$data['int_glcode']; ?>" class="form-horizontal" enctype='multipart/form-data'>
                    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <?php
            if ($data['var_image'] != '') {
                $Image = base_url().'uploads/blog/'.$data['var_image'];
            } else{
