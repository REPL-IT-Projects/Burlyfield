                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                           <a id="add_cate" href="<?php echo base_url(); ?>admin/blog/add_blog" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add New Blog</a>
                       </div>
                   </div>
               </div>
           </div>
                    ...
                    if (count($data) > 0) {
                        foreach ($data as $row) {
                            ...
                            if(substr($row['var_image'], 0, 4 ) === "http")
                            {
                                ...
                                $Image = base_url().'uploads/blog/'.$row['var_image'];
                            } else {
                        ...
                        <td><a href="<?php echo base_url() . 'admin/blog/edit_blog/'. base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['var_name']; ?></a>
                        </td>
