...
class Blog extends Admin_Controller {
	...
	public function index()
	{
		...
		$query = $this->db->where('chr_delete', 'N')->get('mst_blog');
		...
		$this->load_view('blog/view_blog',$data);
	...
	/*------------------ edit view record ----------------------*/ 
	public function edit_blog($userId)
	{
		$userId=base64_decode($userId);
		//echo $userId; exit();
		$data['data'] = $this->model->getIdByData($userId);
		$this->load_view('blog/edit_blog',$data);
	}
