...
class Common_model extends CI_Model 
{
    ...
    public function send_sms($msg,$numbers){
            ...
            $username = "info@suncityclub.in";
            $hash = "5496c5b303abf8e6cb04d47db640b747445dd911";

            // Config variables. Consult http://api.textlocal.in/docs for more info.
            $test = "0";

            // Data for text message. This is the text message data.
            $sender = "SUNCTY"; // This is who the message appears to be from.
           
            // 612 chars or less
            // A single number or a comma-seperated list of numbers
            $message = urlencode('suncityclub.in '.$msg);
            $data = "username=".$username."&hash=".$hash."&message=".$message."&sender=".$sender."&numbers=91".$numbers."&test=".$test;
    ...
    /*------------------------------- get user otp --------------------------- */
    public function send_otp_verification($id,$var_mobile,$tbl_name) 
    {
