            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url();?>admin">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                             <!-- <img src="<?php //echo base_url();?>public/assets/images/site_imges/Logo.png" alt="homepage" class="dark-logo">  -->
                            <!-- Light Logo icon -->
                            <!-- <img src="<?php //echo base_url();?>public/assets/images/Suncity-logo.png" alt="homepage" class="light-logo"> -->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text" style="margin-left: 20px;">
                           <!-- dark Logo text -->
                           <label class="dark-logo">ADMIN PANEL</label>
                           <!-- Light Logo text -->    
               ...
               <div class="navbar-collapse collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav float-left mr-auto">
                    ...
                    <li class="nav-item d-none d-md-block"><a class="nav-link"><h4 style="padding-top: 20px;">BurlyField</h4></a></li>
                </ul>
                <!-- ============================================================== -->
